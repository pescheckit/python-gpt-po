...
class TestIncrementalSave(unittest.TestCase):
    ...
    def test_single_mode_keyboard_interrupt(self, mock_translate):
        ...
        def translate_with_interrupt(text, lang, detail_language=None, context=None, plural_form=None, plural_sources=None):
    ...
    def test_continue_on_error_single_mode(self, mock_translate):
        ...
        def translate_with_error(text, lang, detail_language=None, context=None, plural_form=None, plural_sources=None):
            if "string 5" in text:
